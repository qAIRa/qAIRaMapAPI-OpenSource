...
class TestGetDataHelper(unittest.TestCase):
	...
	def test_get_qhawax_latest_timestamp_processed_measurement_not_valid(self):
		self.assertRaises(TypeError,get_data_helper.getQhawaxLatestTimestampProcessedMeasurement)
		self.assertRaises(TypeError,get_data_helper.getQhawaxLatestTimestampProcessedMeasurement,{"qhawax_id":5})
		self.assertRaises(TypeError,get_data_helper.getQhawaxLatestTimestampProcessedMeasurement,True)
		self.assertRaises(TypeError,get_data_helper.getQhawaxLatestTimestampProcessedMeasurement,-5.0)
		self.assertRaises(TypeError,get_data_helper.getQhawaxLatestTimestampProcessedMeasurement,None)
