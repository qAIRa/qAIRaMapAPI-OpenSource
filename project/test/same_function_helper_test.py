...
class TestSameFunctionHelper(unittest.TestCase):
	...
	#	self.assertAlmostEqual(same_helper.getInstallationId(1),1)
	...
	#	self.assertAlmostEqual(same_helper.getInstallationIdBaseName("qH004"),1)
	...
	def test_query_time_qhawax_history_valid(self):
		initial_timestamp = "29-12-2020 21:30:31.193781+00:00"
		last_timestamp = "29-12-2020 21:30:55.0+00:00"
